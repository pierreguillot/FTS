...
/* 197782 is where the array passed at opcode:33 overflows */
    ...
    FST_UNKNOWN_ENUM(kVstSmpte249fps),
    ...
    FST_UNKNOWN_ENUM(kVstSmpteFilm16mm),
    FST_UNKNOWN_ENUM(kVstSmpteFilm35mm),
